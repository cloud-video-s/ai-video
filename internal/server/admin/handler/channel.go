...
func NewChannelHandler() *ChannelHandler {
	return &ChannelHandler{svc: service.NewChannelService()}
}
...
func (h *ChannelHandler) ListOptions(c *gin.Context) {
...
func (h *ChannelHandler) Create(c *gin.Context) {
	var req service.ChannelPayload
...
func (h *ChannelHandler) UpdateStatus(c *gin.Context) {
	...
	var req service.ChannelStatusPayload
	if err := c.ShouldBindJSON(&req); err != nil {
		response.Fail(c, errcode.ErrParam, "参数错误: "+err.Error())
		return
	}
