...
type VideoUser struct {
	...
	VipPoints                int64                      `gorm:"column:vip_points;type:bigint;not null;comment:vip_积分" json:"vip_points"`                                                                                                         // vip_积分
	PointsBalance            int64                      `gorm:"column:points_balance;type:bigint;not null;comment:积分" json:"points_balance"`                                                                                                     // 积分
