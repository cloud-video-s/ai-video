...
type VideoTemplate struct {
	...
	DisplayPosition      []*VideoDisplayPosition `gorm:"References:PositionKey;foreignKey:ID;joinForeignKey:TemplateID;joinReferences:PositionKey;many2many:video_template_display_config" json:"display_position"`
}
