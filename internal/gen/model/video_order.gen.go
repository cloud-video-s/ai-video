...
type VideoOrder struct {
	...
	Status                uint32         `gorm:"column:status;type:tinyint unsigned;not null;index:idx_video_order_status,priority:1;default:1;comment:订单状态 1=待支付 2=支付中 3=支付成功 4=订单完成5=订单取消 6=订单退款" json:"status"`     // 订单状态 1=待支付 2=支付中 3=支付成功 4=订单完成5=订单取消 6=订单退款
	...
	PayAt                 time.Time      `gorm:"column:pay_at;type:datetime;index:idx_video_order_paid_at,priority:1;comment:支付完成时间" json:"pay_at"`                                                                    // 支付完成时间
