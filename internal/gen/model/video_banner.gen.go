...
type VideoBanner struct {
	...
	Placement          []*VideoBannerPlacementAssociation `gorm:"References:PlacementKey;foreignKey:ID;joinForeignKey:BannerID;joinReferences:PlacementKey;many2many:video_banner_placement_association" json:"placement"`
	Countrys           []*VideoCountry                    `gorm:"References:Code;foreignKey:ID;joinForeignKey:BannerID;joinReferences:CountryCode;many2many:video_banner_country" json:"countrys"`
	App                []*VideoApp                        `gorm:"References:AppCode;foreignKey:ID;joinForeignKey:BannerID;joinReferences:AppCode;many2many:video_banner_app" json:"app"`
	Package            []*VideoPackage                    `gorm:"References:PackageCode;foreignKey:ID;joinForeignKey:BannerID;joinReferences:PackageCode;many2many:video_banner_package" json:"package"`
	Version            []*VideoPackageVersion             `gorm:"References:VersionCode;foreignKey:ID;joinForeignKey:BannerID;joinReferences:VersionCode;many2many:video_banner_version" json:"version"`
}
