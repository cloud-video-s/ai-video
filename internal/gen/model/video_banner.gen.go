...
type VideoBanner struct {
	...
	DisplayPosition    []*VideoDisplayPosition `gorm:"References:PositionKey;foreignKey:ID;joinForeignKey:BannerID;joinReferences:PositionKey;many2many:video_banner_display_position" json:"display_position"`
	...
	Package            []*VideoPackage         `gorm:"References:PackageCode;foreignKey:ID;joinForeignKey:BannerID;joinReferences:PackageCode;many2many:video_banner_app" json:"package"`
	Version            []*VideoPackageVersion  `gorm:"References:VersionCode;foreignKey:ID;joinForeignKey:BannerID;joinReferences:VersionCode;many2many:video_banner_app" json:"version"`
}
