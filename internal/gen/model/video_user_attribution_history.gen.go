...
type VideoUserAttributionHistory struct {
	...
	AdjustAdid                string         `gorm:"column:adjust_adid;type:varchar(64);not null;uniqueIndex:uk_adjust_id,priority:1;comment:Adjust设备ID（唯一标识，用于融合匹配）" json:"adjust_adid"` // Adjust设备ID（唯一标识，用于融合匹配）
	...
	Network                   string         `gorm:"column:network;type:varchar(255);comment:广告媒体" json:"network"`                                                                        // 广告媒体
	Campaign                  string         `gorm:"column:campaign;type:varchar(255);comment:广告系列" json:"campaign"`                                                                      // 广告系列
	Adgroup                   string         `gorm:"column:adgroup;type:varchar(255);comment:广告组" json:"adgroup"`                                                                         // 广告组
	Creative                  string         `gorm:"column:creative;type:varchar(255);comment:广告" json:"creative"`                                                                        // 广告
