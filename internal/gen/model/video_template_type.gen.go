...
type VideoTemplateType struct {
	...
	Package              []*VideoPackage         `gorm:"References:PackageCode;foreignKey:ID;joinForeignKey:TemplateTypeID;joinReferences:PackageCode;many2many:video_template_type_app" json:"package"`
	Version              []*VideoPackageVersion  `gorm:"References:VersionCode;foreignKey:ID;joinForeignKey:TemplateTypeID;joinReferences:VersionCode;many2many:video_template_type_app" json:"version"`
}
