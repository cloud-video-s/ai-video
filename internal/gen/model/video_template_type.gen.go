...
type VideoTemplateType struct {
	...
	Templates            []VideoTemplate        `gorm:"foreignKey:VideoTemplateTypeID;references:ID" json:"templates"`
	DisplayPositions     []VideoDisplayPosition `gorm:"foreignKey:ID;joinForeignKey:TemplateTypeID;joinReferences:PositionKey;many2many:video_template_type_display_position;references:PositionKey" json:"display_positions"`
	Countries            []VideoCountry         `gorm:"foreignKey:ID;joinForeignKey:TemplateTypeID;joinReferences:CountryCode;many2many:video_template_type_country;references:Code" json:"countries"`
	Apps                 []VideoApp             `gorm:"foreignKey:ID;joinForeignKey:TemplateTypeID;joinReferences:AppID;many2many:video_template_type_app;references:ID" json:"apps"`
	Packages             []VideoPackage         `gorm:"foreignKey:ID;joinForeignKey:TemplateTypeID;joinReferences:PackageID;many2many:video_template_type_package;references:ID" json:"packages"`
	Versions             []VideoPackageVersion  `gorm:"foreignKey:ID;joinForeignKey:TemplateTypeID;joinReferences:VersionID;many2many:video_template_type_version;references:ID" json:"versions"`
}
