...
type VideoTemplateType struct {
	...
	Channels             []VideoChannel         `gorm:"References:ChannelCode;foreignKey:ID;joinForeignKey:TemplateTypeID;joinReferences:ChannelCode;many2many:video_template_type_channel" json:"channels"`
	Countries            []VideoCountry         `gorm:"References:Code;foreignKey:ID;joinForeignKey:TemplateTypeID;joinReferences:CountryCode;many2many:video_template_type_country" json:"countries"`
	DisplayPositions     []VideoDisplayPosition `gorm:"References:PositionKey;foreignKey:ID;joinForeignKey:TemplateTypeID;joinReferences:PositionKey;many2many:video_template_type_display_position" json:"display_positions"`
	Packages             []VideoPackage         `gorm:"References:PackageCode;foreignKey:ID;joinForeignKey:TemplateTypeID;joinReferences:PackageCode;many2many:video_template_type_package" json:"packages"`
}
