...
type VideoUpload struct {
	...
	UserType        int32          `gorm:"column:user_type;type:tinyint;not null;index:idx_video_upload_owner,priority:1;comment:用户类型 1=admin 2=客户端" json:"user_type"` // 用户类型 1=admin 2=客户端
