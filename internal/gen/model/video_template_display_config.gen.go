...
type VideoTemplateDisplayConfig struct {
	...
	PositionKey     string               `gorm:"column:position_key;type:varchar(64);not null;index:idx_position_key,priority:2" json:"position_key"`
	...
	DisplayPosition VideoDisplayPosition `gorm:"foreignKey:PositionKey;references:PositionKey" json:"display_position"`
}
